...
description: Crie formulários uma vez e entregue ao CMS, React, SPAs, Web, dispositivos móveis, Alexa, WhatsApp e muito mais, com os formulários adaptáveis do AEM Headless para uma captura de dados rápida e escalável.
