---
title: Crie e Publish um formulário headless com o Adobe Experience Manager Adaptive Forms | Guia Passo a Passo
...
> * Você pode criar o formulário JSON manualmente ou usar o [editor de formulários adaptáveis para AEM (editor de formulários adaptáveis WYSIWYG)](create-a-headless-adaptive-form.md) para criar e entregar o formulário JSON. Em um ambiente de produção, você usa o AEM Forms para fornecer o formulário JSON, mais informações sobre ele posteriormente.
...
Por padrão, o kit inicial usa componentes de [Espectro de Adobe](https://spectrum.adobe.com/) para renderizar o formulário. Você pode usar a opção criar e usar seus próprios componentes ou componentes de terceiros. Por exemplo, usando a Google Material UI ou a Chakra UI.

Vamos [usar a Interface do Usuário do Material do Google](use-google-material-ui-react-components-to-render-a-headless-form.md) para renderizar nosso formulário Fale Conosco.
